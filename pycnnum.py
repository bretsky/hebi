...
if 'constants':  # for code folding
    ...
    SMALLER_BIG_CHINESE_UNITS_TRADITIONAL = '十百千万'
    LARGER_CHINESE_NUMERING_UNITS_SIMPLIFIED = '億兆京垓秭穰溝澗正載'
    LARGER_CHINESE_NUMERING_UNITS_TRADITIONAL = '億兆京垓秭穰溝澗正載'
    SMALLER_CHINESE_NUMERING_UNITS_SIMPLIFIED = '十百千万'
    SMALLER_CHINESE_NUMERING_UNITS_TRADITIONAL = '十百千万'
...
def num2cn(num, numbering_type=NUMBERING_TYPES[1], big=False, traditional=False, alt_zero=False, alt_two=False, use_zeros=True):
    ...
    return result.replace('一十', '十').replace('一百', '百').replace('一千', '千')
