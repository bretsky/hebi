...
int acceptablenonalpha(int code) {
    if (code >= 19968 && code <= 40959) { // kanji
        return 1;
    }
    if (code >= 12352 && code <= 12447) { // hiragana
        return 1;
    }
    if (code >= 12448 && code <= 12543) { // katakana
        return 1;
    }
    if (code == 65306 || code == 65290 || code == 12289 || code == 12290) { // fullwidth symbols
        return 1;
    }
    return 0;
}
